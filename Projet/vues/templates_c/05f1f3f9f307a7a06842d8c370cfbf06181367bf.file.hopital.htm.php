<?php /* Smarty version Smarty-3.1.14, created on 2013-12-07 20:21:07
         compiled from "vues\templates\hopital.htm" */ ?>
<?php /*%%SmartyHeaderCode:416252a3833309a0e5-41929894%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05f1f3f9f307a7a06842d8c370cfbf06181367bf' => 
    array (
      0 => 'vues\\templates\\hopital.htm',
      1 => 1386447608,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '416252a3833309a0e5-41929894',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_52a383339fc2a0_47250235',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52a383339fc2a0_47250235')) {function content_52a383339fc2a0_47250235($_smarty_tpl) {?>﻿<!DOCTYPE html>
<html lang="fr">
<head>
...
<div id="content" class="span10"> <!-- start: Content -->
	...
	<div>
		<a class="btn btn-success" id="" href="javascript:Ajouter();"><i class="icon-plus-sign icon-white"></i> Ajouter une nouveau hopital</a>
	</div>
...
?>
						...
						<tr id="<?php echo $_smarty_tpl->tpl_vars['hopital']->value->getId();?>
" class="odd gradeX">
							<td><?php echo utf8_encode($_smarty_tpl->tpl_vars['hopital']->value->getDesignation());?>
</td>
							<td><?php echo $_smarty_tpl->tpl_vars['hopital']->value->getX();?>
</td>
							<td><?php echo $_smarty_tpl->tpl_vars['hopital']->value->getY();?>
</td>
							<td class="center">
								<a class="btn btn-success" href="index.php?page=hopital&action=afficher&id=<?php echo $_smarty_tpl->tpl_vars['hopital']->value->getId();?>
">
									<i class="icon-zoom-in icon-white afficher"></i>  
								</a>
								<a class="btn btn-info edit" href="javascript:Update(<?php echo $_smarty_tpl->tpl_vars['hopital']->value->getId();?>
);">
									<i class="icon-edit icon-white"></i>  
								</a>
								<a class="btn btn-danger delete" href="javascript:Delete(<?php echo $_smarty_tpl->tpl_vars['hopital']->value->getId();?>
);">
